#!/usr/bin/env python3
"""
NOLIE Deepfake Detection System Startup Script
Created by Dogan Ege BULTE

This script provides a comprehensive way to start the NOLIE system
with the React-based web interface and enhanced AI accuracy.
"""
...
class NOLIESystem:
    """Main class for managing the NOLIE system."""
...
"""
    ...
    def check_dependencies(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                print(f"{Colors.GREEN}✅ npm {result.stdout.strip()} detected{Colors.END}")
            else:
        ...
        required_packages = ['fastapi', 'uvicorn', 'torch', 'numpy', 'pillow', 'requests']
        missing_packages = []
        ...
        if missing_packages:
            ...
            try:
                ...
                print(f"{Colors.RED}❌ Failed to install Python packages: {e}{Colors.END}")
                return False
    ...
    def install_web_dependencies(self) -> bool:
        ...
        print(f"{Colors.BLUE}📦 Installing web dependencies...{Colors.END}")
        ...
        try:
            ...
            if result.returncode == 0:
                print(f"{Colors.GREEN}✅ Web dependencies installed successfully{Colors.END}")
                return True
            else:
            ...
            print(f"{Colors.RED}❌ Error installing web dependencies: {e}{Colors.END}")
            return False
    ...
    def start_web_server(self) -> bool:
        """Start the React web development server."""
        print(f"{Colors.BLUE}🚀 Starting NOLIE Web Interface...{Colors.END}")
        ...
        try:
            ...
            for i in range(20):
                ...
                try:
                    ...
                    if response.status_code == 200:
                        print(f"{Colors.GREEN}✅ NOLIE Web Interface started successfully{Colors.END}")
                        print(f"{Colors.BLUE}🌐 Web interface available at: {self.web_url}{Colors.END}")
                        return True
                except requests.exceptions.RequestException:
                    continue
    ...
    def test_system(self) -> bool:
        ...
        try:
            ...
            if response.status_code != 200:
                print(f"{Colors.RED}❌ Web interface check failed{Colors.END}")
                return False
            
            print(f"{Colors.GREEN}✅ Web interface check passed{Colors.END}")
    ...
    def show_status(self):
        ...
        print(f"{Colors.BLUE}🌐 Web Interface: {self.web_url}{Colors.END}")
